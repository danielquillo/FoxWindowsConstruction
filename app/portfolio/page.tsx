...
type Category = "all" | "service 1" | "service 2" | "service 3";
      ...
      <section className="mx-auto max-w-screen-xl px-4 sm:px-6 lg:px-8 pt-12 pb-6">
        <div className="max-w-2xl">
          ...
          <p className="mt-3 text-[15px] md:text-[16px] text-neutral-600">
            Portfolio description goes here. Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.
          </p>
        </div>
        ...
        <div className="mt-6 flex flex-wrap gap-2">
          ...
          <FilterPill label="Service 1" active={filter === "service 1"} onClick={() => setFilter("service 1")} />
          <FilterPill label="Service 2" active={filter === "service 2"} onClick={() => setFilter("service 2")} />
          <FilterPill label="Service 3" active={filter === "service 3"} onClick={() => setFilter("service 3")} />
        </div>
      </section>
